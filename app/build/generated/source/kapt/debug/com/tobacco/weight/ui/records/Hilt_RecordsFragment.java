...
abstract class Hilt_RecordsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RecordsFragment() {
    super();
  }

  Hilt_RecordsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecordsFragment_GeneratedInjector) this.generatedComponent()).injectRecordsFragment(UnsafeCasts.<RecordsFragment>unsafeCast(this));
    }
  }
