...
abstract class Hilt_PrecheckFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PrecheckFragment() {
    super();
  }

  Hilt_PrecheckFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PrecheckFragment_GeneratedInjector) this.generatedComponent()).injectPrecheckFragment(UnsafeCasts.<PrecheckFragment>unsafeCast(this));
    }
  }
