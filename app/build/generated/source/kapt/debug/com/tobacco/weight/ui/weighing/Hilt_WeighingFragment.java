...
abstract class Hilt_WeighingFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_WeighingFragment() {
    super();
  }

  Hilt_WeighingFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WeighingFragment_GeneratedInjector) this.generatedComponent()).injectWeighingFragment(UnsafeCasts.<WeighingFragment>unsafeCast(this));
    }
  }
