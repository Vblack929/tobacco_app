...
abstract class Hilt_WeightingFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_WeightingFragment() {
    super();
  }

  Hilt_WeightingFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WeightingFragment_GeneratedInjector) this.generatedComponent()).injectWeightingFragment(UnsafeCasts.<WeightingFragment>unsafeCast(this));
    }
  }
